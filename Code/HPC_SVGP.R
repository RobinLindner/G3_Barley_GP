...
for(i in 1:length(focal_traits)){
  ...
  for(j in 1:length(dats_foc)){
    ...
    res = nFoldCV_lm_combined(BLUPs_normalized, trait, dat_foc,K, H, CV_mat ,genotypes)
