...
output_path="Data/Generated/GenomicPrediction/UVGP/"
output_file="Data/Generated/GenomicPrediction/UVGP/${trait}_${dat}_accuracy.csv"
...
Rscript Code/HPC_SVGP.R ${output_path} ${trait} ${dat} Supplements/GP_CV_mat2.csv $scenarioID
